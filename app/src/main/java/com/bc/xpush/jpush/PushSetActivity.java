...
import static com.bc.xpush.jpush.TagAliasOperatorHelper.ACTION_ADD;
import static com.bc.xpush.jpush.TagAliasOperatorHelper.ACTION_CHECK;
import static com.bc.xpush.jpush.TagAliasOperatorHelper.ACTION_CLEAN;
import static com.bc.xpush.jpush.TagAliasOperatorHelper.ACTION_DELETE;
import static com.bc.xpush.jpush.TagAliasOperatorHelper.ACTION_GET;
import static com.bc.xpush.jpush.TagAliasOperatorHelper.ACTION_SET;
import static com.bc.xpush.jpush.TagAliasOperatorHelper.TagAliasBean;
import static com.bc.xpush.jpush.TagAliasOperatorHelper.sequence;
...
public class PushSetActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.jpush_demo_push_set_dialog);
        initListener();
    }
    ...
    private void setStyleCustom() {
        CustomPushNotificationBuilder builder = new CustomPushNotificationBuilder(PushSetActivity.this, R.layout.jpush_demo_customer_notitfication_layout, R.id.icon, R.id.title, R.id.text);
    ...
    private void handleSetMobileNumber(){
        ...
        if (TextUtils.isEmpty(mobileNumber)) {
            Toast.makeText(getApplicationContext(), R.string.jpush_demo_mobilenumber_empty_guide, Toast.LENGTH_SHORT).show();
        }
        if (!ExampleUtil.isValidMobileNumber(mobileNumber)) {
            Toast.makeText(getApplicationContext(), R.string.jpush_demo_error_tag_gs_empty, Toast.LENGTH_SHORT).show();
            return;
        }
        sequence++;
    ...
    private String getInPutAlias(){
        ...
        if (TextUtils.isEmpty(alias)) {
            Toast.makeText(getApplicationContext(), R.string.jpush_demo_error_alias_empty, Toast.LENGTH_SHORT).show();
            return null;
        }
    ...
    private Set<String> getInPutTags(){
        ...
        if (TextUtils.isEmpty(tag)) {
            Toast.makeText(getApplicationContext(), R.string.jpush_demo_error_tag_empty, Toast.LENGTH_SHORT).show();
            return null;
        }
